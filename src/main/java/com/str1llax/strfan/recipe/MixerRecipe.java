...
public class MixerRecipe implements Recipe<SimpleContainer> {
    ...
    public MixerRecipe(ResourceLocation id, ItemStack output,
    ...
    public static class Serializer implements RecipeSerializer<MixerRecipe> {
        ...
        public static final ResourceLocation ID =
                new ResourceLocation(Str1llaxsFantasy.MOD_ID,"mixing");
        ...
        public MixerRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new MixerRecipe(id, output, inputs);
        }

        @Override
        public MixerRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
