...
public class SFConfiguredFeatures {
    ...
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> HEVEA_TREE =
            FeatureUtils.register("hevea", Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                    BlockStateProvider.simple(SFBlocks.HEVEA_LOG.get()),
                    new StraightTrunkPlacer(4, 2, 0),
                    BlockStateProvider.simple(SFBlocks.HEVEA_LEAVES.get()),
    ...
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> CHESTNUT_TREE =
            FeatureUtils.register("chestnut", Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                    BlockStateProvider.simple(SFBlocks.CHESTNUT_LOG.get()),
                    new FancyTrunkPlacer(3, 11, 0),
                    BlockStateProvider.simple(SFBlocks.CHESTNUT_LEAVES.get()),
    ...
    public static final Holder<ConfiguredFeature<RandomFeatureConfiguration, ?>> CHESTNUT_SPAWN =
