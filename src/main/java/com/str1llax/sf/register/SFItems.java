...
public class SFItems extends Item {
    ...
    public static final RegistryObject<Item> RUBY_HELMET = register("ruby_helmet",() -> new ModArmorItem(SFArmorMaterials.RUBY,EquipmentSlot.HEAD,new Item.Properties().tab(SFTabs.SFTAB_ARMOR)));
    ...
    public static final RegistryObject<Item> CITRINE_HELMET = register("citrine_helmet",() -> new ModArmorItem(SFArmorMaterials.CITRINE,EquipmentSlot.HEAD,new Item.Properties().tab(SFTabs.SFTAB_ARMOR)));
