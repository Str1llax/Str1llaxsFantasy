...
public class SFBlocks {
    ...
    public static final RegistryObject<Block> ADVANCED_BLOCK = register("advanced_block",
            () -> new AdvancedBlock(BlockBehaviour.Properties.copy(Blocks.OBSIDIAN)
                    .strength(3.0f).sound(SoundType.METAL)
                    .requiresCorrectToolForDrops()
                    .emissiveRendering((state,getter,pos) -> {
                        return true;
                    })
                    .lightLevel(state -> 0).dynamicShape()),object -> () -> new BlockItem(object.get(),new Item.Properties()));
    ...
    public static final RegistryObject<Block> HEVEA_STAIRS = register("hevea_stairs",
            () -> new StairBlock(() -> SFBlocks.HEVEA_PLANKS.get().defaultBlockState(),BlockBehaviour.Properties.copy(Blocks.OAK_STAIRS)),
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    ...
    public static final RegistryObject<Block> HEVEA_FENCE = register("hevea_fence",
            () -> new FenceBlock(BlockBehaviour.Properties.of(Material.WOOD,HEVEA_PLANKS.get().defaultMaterialColor())
    ...
    public static final RegistryObject<Block> HEVEA_SAPLING = register("hevea_sapling",
            () -> new SaplingBlock(new HeveaTreeGrower(),BlockBehaviour.Properties.copy(Blocks.OAK_SAPLING).noOcclusion()),
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    // CHESTNUT
    public static final RegistryObject<Block> CHESTNUT_LOG = register("chestnut_log",
            () -> new SFFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)),
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    public static final RegistryObject<Block> CHESTNUT_WOOD = register("chestnut_wood",
            () -> new SFFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WOOD)),
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    public static final RegistryObject<Block> STRIPPED_CHESTNUT_LOG = register("stripped_chestnut_log",
            () -> new SFFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_OAK_LOG)),
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    public static final RegistryObject<Block> STRIPPED_CHESTNUT_WOOD = register("stripped_chestnut_wood",
            () -> new SFFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_OAK_WOOD)),
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    public static final RegistryObject<Block> CHESTNUT_PLANKS = register("chestnut_planks",
            () -> new SFFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS)) {
                @Override
                public boolean isFlammable(BlockState state,BlockGetter world,BlockPos pos,Direction face) {return true;}
                @Override
                ...
                public int getFireSpreadSpeed(BlockState state,BlockGetter world,BlockPos pos,Direction face) {return 5;}},
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    public static final RegistryObject<Block> CHESTNUT_STAIRS = register("chestnut_stairs",
            () -> new StairBlock(() -> SFBlocks.CHESTNUT_PLANKS.get().defaultBlockState(),BlockBehaviour.Properties.copy(Blocks.OAK_STAIRS)),
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    public static final RegistryObject<Block> CHESTNUT_SLAB = register("chestnut_slab",
            () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.OAK_SLAB)),
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    public static final RegistryObject<Block> CHESTNUT_FENCE = register("chestnut_fence",
            () -> new FenceBlock(BlockBehaviour.Properties.of(Material.WOOD,CHESTNUT_PLANKS.get().defaultMaterialColor()).strength(2.0F,3.0F).sound(SoundType.WOOD)),
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    public static final RegistryObject<Block> CHESTNUT_FENCE_GATE = register("chestnut_fence_gate",
            () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.OAK_FENCE_GATE)),
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    public static final RegistryObject<Block> CHESTNUT_BUTTON = register("chestnut_button",
            () -> new WoodButtonBlock(BlockBehaviour.Properties.copy(Blocks.OAK_BUTTON)),
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    public static final RegistryObject<Block> CHESTNUT_PRESSURE_PLATE = register("chestnut_pressure_plate",
            () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING,BlockBehaviour.Properties.copy(Blocks.OAK_PRESSURE_PLATE)),
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    public static final RegistryObject<Block> CHESTNUT_DOOR = register("chestnut_door",
            () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_DOOR)),
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    public static final RegistryObject<Block> CHESTNUT_TRAPDOOR = register("chestnut_trapdoor",
            () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_TRAPDOOR)),
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    public static final RegistryObject<Block> CHESTNUT_LEAVES = register("chestnut_leaves",
            () -> new LeavesBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LEAVES).noOcclusion()) {
                @Override
                public boolean isFlammable(BlockState state,BlockGetter world,BlockPos pos,Direction face) {return true;}
                @Override
    ...
    public static final RegistryObject<Block> CITRINE_ORE = register("citrine_ore",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.DIAMOND_ORE)),
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    public static final RegistryObject<Block> DEEPSLATE_CITRINE_ORE = register("deepslate_citrine_ore",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.DEEPSLATE_DIAMOND_ORE)),
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    public static final RegistryObject<Block> CABLE_IRON = register("cable_iron",
            () -> new CableIron(BlockBehaviour.Properties.copy(Blocks.LIGHT_GRAY_WOOL)),
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    ...
    public static final RegistryObject<Block> EXTRACTOR = register("extractor",
            ...
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    public static final RegistryObject<Block> CHIP_PRESS = register("chip_press",
            () -> new ChipPress(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)),
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    public static final RegistryObject<Block> GEM_COMBINER = register("gem_combiner",
            () -> new GemCombiner(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)),
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    public static final RegistryObject<Block> GENERATOR = register("generator",
            ...
            object -> () -> new BlockItem(object.get(),new Item.Properties()));
    private static <T extends Block> RegistryObject<T> registerBlock(final String name,final Supplier<? extends T> block,CreativeModeTab SFTab) {
    ...
    private static <T extends Block> RegistryObject<T> register(final String name,final Supplier<? extends T> block,Function<RegistryObject<T>,Supplier<? extends Item>> item) {
        RegistryObject<T> obj = registerBlock(name,block,SFTabs.SFTAB);ITEMS.register(name,item.apply(obj));return obj;
    }
