...
public class SFBlocks {
    ...
    public static final RegistryObject<Block> CHIP_PRESS = register("chip_press",() -> new ChipPress(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)),object -> () -> new BlockItem(object.get(),new Item.Properties().tab(SFTabs.SFTAB_MACHINES)));
    public static final RegistryObject<Block> GEM_COMBINER = register("gem_combiner",() -> new GemCombiner(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)), object -> () -> new BlockItem(object.get(),new Item.Properties().tab(SFTabs.SFTAB_MACHINES)));
