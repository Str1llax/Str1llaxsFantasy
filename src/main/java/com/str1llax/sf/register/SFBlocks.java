...
public class SFBlocks {
    ...
    public static final RegistryObject<Block> GEM_INFUSER = register("gem_infuser",() -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)),object -> () -> new BlockItem(object.get(),new Item.Properties().tab(SFTabs.SFTAB_MACHINES)));
