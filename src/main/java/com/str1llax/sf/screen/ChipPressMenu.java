...
public class ChipPressMenu extends AbstractContainerMenu {
    private final ChipPressBlockEntity blockEntity;
    ...
    public ChipPressMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data ) {
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 73, 21));
            this.addSlot(new SlotItemHandler(handler, 1, 73, 52));
            this.addSlot(new SFResultSlot(handler, 2, 109, 36));
        });
    ...
    public boolean stillValid(@NotNull Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, SFBlocks.CHIP_PRESS.get());
    }
