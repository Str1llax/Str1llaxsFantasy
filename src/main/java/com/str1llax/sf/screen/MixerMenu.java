...
import com.str1llax.sf.block.entity.sfentities.MixerBlockEntity;
...
public class MixerMenu extends AbstractContainerMenu {
    ...
    public MixerMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data ) {
        super(SFMenuTypes.MIXER_MENU.get() ,pContainerId);
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 62, 14));
            this.addSlot(new SlotItemHandler(handler, 1, 98, 14));
            this.addSlot(new SFResultSlot(handler, 2, 80, 57));
        });
