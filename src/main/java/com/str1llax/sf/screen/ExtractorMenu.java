...
public class ExtractorMenu extends AbstractContainerMenu {
    ...
    public ExtractorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data ) {
        super(SFMenuTypes.EXTRACTOR_MENU.get() ,pContainerId);
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 57, 35));
            this.addSlot(new SFResultSlot(handler, 1, 103, 35));
        });
    ...
    public boolean stillValid(@NotNull Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, SFBlocks.EXTRACTOR.get());
    }
